...
<?php
	...
	<form action ='' method ='post'>
		...
		<textarea name='pDesc' cols='60' rows='2'><?php if(isset($error)){ echo $_POST['pDESC']; }?></textarea></p>

		<p><label>Contents</label><br />
		<textarea name='pContents' cols='60' rows='10'><?php if(isset($error)){ echo $_POST['pContents']; }?></textarea></p>
